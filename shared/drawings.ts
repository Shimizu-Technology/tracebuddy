...
import { revisedTemplateSvgs } from './revisedTemplates'
...
const curatedDrawings: Drawing[] = [
  {
    ...
    name: 'Flower Head',
    theme: 'Petals and details',
    category: 'nature',
    collection: 'curated',
    difficulty: 'Detailed',
    svg: revisedTemplateSvgs['curated-flower-head-008'],
  },
  {
  ...
  },
  {
    ...
    collection: 'curated',
    difficulty: 'Detailed',
    svg: revisedTemplateSvgs['curated-shell-057'],
  },
  {
    id: 'curated-car-062',
    name: 'Simple Car',
    theme: 'Vehicle shapes',
    category: 'vehicles',
    collection: 'curated',
    difficulty: 'Starter',
    svg: revisedTemplateSvgs['curated-car-062'],
  },
  {
  ...
  },
  {
    ...
    name: 'Detailed Snowflake',
    theme: 'Winter symmetry',
    category: 'seasonal',
    collection: 'curated',
    difficulty: 'Detailed',
  ...
  },
  {
    ...
    name: 'Jack-o’-Lantern',
    theme: 'Autumn details',
    category: 'seasonal',
    collection: 'curated',
    difficulty: 'Medium',
    svg: revisedTemplateSvgs['curated-pumpkin-097'],
  },
  {
  ...
  },
  {
    id: 'curated-rose-117',
    name: 'Rose',
    theme: 'Petals and leaves',
    category: 'nature',
    collection: 'curated',
    difficulty: 'Detailed',
    svg: revisedTemplateSvgs['curated-rose-117'],
  },
  {
    id: 'curated-fish-118',
    name: 'Cartoon Fish',
...
const legacyDrawings: Drawing[] = [
  ...curatedDrawings,
  {
    id: 'flower',
    name: 'Happy Flower',
    theme: 'Petal practice',
    category: 'starters',
    difficulty: 'Medium',
    svg: revisedTemplateSvgs.flower,
  },
  {
    id: 'smiling-star',
    name: 'Smiling Star',
...
type DrawingMetadata = Pick<Drawing, 'name' | 'theme' | 'category' | 'difficulty'>

const normalizedLegacyMetadata: Record<string, DrawingMetadata> = {
  'curated-flower-head-008': { name: 'Flower Head', theme: 'Petals and details', category: 'nature', difficulty: 'Detailed' },
  'curated-cute-crab-056': { name: 'Cute Crab', theme: 'Ocean details', category: 'ocean', difficulty: 'Medium' },
  'curated-shell-057': { name: 'Scallop Shell', theme: 'Shell details', category: 'ocean', difficulty: 'Detailed' },
  'curated-car-062': { name: 'Simple Car', theme: 'Vehicle shapes', category: 'vehicles', difficulty: 'Starter' },
  'curated-rocket-064': { name: 'Rocket', theme: 'Space flight', category: 'vehicles', difficulty: 'Starter' },
  'curated-kite-070': { name: 'Diamond Kite', theme: 'Windy-day lines', category: 'seasonal', difficulty: 'Starter' },
  'curated-snowflake-080': { name: 'Detailed Snowflake', theme: 'Winter symmetry', category: 'seasonal', difficulty: 'Detailed' },
  'curated-palm-tree-081': { name: 'Palm Tree', theme: 'Tropical details', category: 'island', difficulty: 'Detailed' },
  'curated-pine-tree-088': { name: 'Pine Tree', theme: 'Branch patterns', category: 'nature', difficulty: 'Medium' },
  'curated-pumpkin-097': { name: 'Jack-o’-Lantern', theme: 'Autumn details', category: 'seasonal', difficulty: 'Medium' },
  'curated-airplane-110': { name: 'Propeller Airplane', theme: 'Vehicle details', category: 'vehicles', difficulty: 'Medium' },
  'curated-rose-117': { name: 'Rose', theme: 'Petals and leaves', category: 'nature', difficulty: 'Detailed' },
  'curated-fish-118': { name: 'Cartoon Fish', theme: 'Ocean details', category: 'ocean', difficulty: 'Medium' },
  'curated-flower-120': { name: 'Garden Flower', theme: 'Petals and leaves', category: 'nature', difficulty: 'Medium' },
  'curated-long-stem-flower-257': { name: 'Simple Daisy', theme: 'Curves and petals', category: 'nature', difficulty: 'Starter' },
  flower: { name: 'Happy Flower', theme: 'Petal practice', category: 'starters', difficulty: 'Medium' },
  'smiling-star': { name: 'Smiling Star', theme: 'Shape warmup', category: 'starters', difficulty: 'Starter' },
  'cozy-house': { name: 'Cozy House', theme: 'House shapes', category: 'starters', difficulty: 'Starter' },
  'friendly-sun': { name: 'Friendly Sun', theme: 'Ray warmup', category: 'starters', difficulty: 'Starter' },
  butterfly: { name: 'Butterfly', theme: 'Symmetry practice', category: 'animals', difficulty: 'Medium' },
  puppy: { name: 'Puppy Pal', theme: 'Animal friend', category: 'animals', difficulty: 'Starter' },
  'sleepy-cat': { name: 'Sleepy Cat', theme: 'Animal friend', category: 'animals', difficulty: 'Starter' },
  bunny: { name: 'Bouncy Bunny', theme: 'Animal friend', category: 'animals', difficulty: 'Starter' },
  'gentle-elephant': { name: 'Gentle Elephant', theme: 'Big animal shapes', category: 'animals', difficulty: 'Medium' },
  panda: { name: 'Round Panda', theme: 'Animal friend', category: 'animals', difficulty: 'Starter' },
  'little-duck': { name: 'Little Duck', theme: 'Animal friend', category: 'animals', difficulty: 'Starter' },
  'curly-snail': { name: 'Curly Snail', theme: 'Loop practice', category: 'animals', difficulty: 'Starter' },
  'island-turtle': { name: 'Sea Turtle', theme: 'Shell patterns', category: 'ocean', difficulty: 'Medium' },
  'friendly-fish': { name: 'Friendly Fish', theme: 'Ocean friend', category: 'ocean', difficulty: 'Starter' },
  seahorse: { name: 'Friendly Seahorse', theme: 'Ocean curves', category: 'ocean', difficulty: 'Medium' },
  starfish: { name: 'Smiling Sea Star', theme: 'Ocean shapes', category: 'ocean', difficulty: 'Starter' },
  'happy-crab': { name: 'Happy Crab', theme: 'Ocean friend', category: 'ocean', difficulty: 'Medium' },
  'tiny-whale': { name: 'Tiny Whale', theme: 'Ocean friend', category: 'ocean', difficulty: 'Starter' },
  octopus: { name: 'Happy Octopus', theme: 'Ocean friend', category: 'ocean', difficulty: 'Medium' },
  shell: { name: 'Spiral Shell', theme: 'Ocean curves', category: 'ocean', difficulty: 'Starter' },
  'dream-unicorn': { name: 'Dream Unicorn', theme: 'Magic animal', category: 'magic', difficulty: 'Medium' },
  'fairy-wand': { name: 'Fairy Wand', theme: 'Magic shapes', category: 'magic', difficulty: 'Starter' },
  'storybook-castle': { name: 'Story Castle', theme: 'Castle shapes', category: 'magic', difficulty: 'Medium' },
  'tiny-dragon': { name: 'Baby Dragon', theme: 'Magic animal', category: 'magic', difficulty: 'Medium' },
  'royal-crown': { name: 'Royal Crown', theme: 'Magic shapes', category: 'magic', difficulty: 'Starter' },
  'rainbow-cloud': { name: 'Rainbow Cloud', theme: 'Rainbow curves', category: 'magic', difficulty: 'Starter' },
  'rocket-ship': { name: 'Rocket Ship', theme: 'Space vehicle', category: 'vehicles', difficulty: 'Medium' },
  'race-car': { name: 'Race Car', theme: 'Vehicle shapes', category: 'vehicles', difficulty: 'Starter' },
  airplane: { name: 'Airplane', theme: 'Vehicle shapes', category: 'vehicles', difficulty: 'Starter' },
  'delivery-truck': { name: 'Delivery Truck', theme: 'Vehicle shapes', category: 'vehicles', difficulty: 'Starter' },
  sailboat: { name: 'Sailboat', theme: 'Boat shapes', category: 'vehicles', difficulty: 'Starter' },
  scooter: { name: 'Kick Scooter', theme: 'Wheels and lines', category: 'vehicles', difficulty: 'Medium' },
  'abc-practice': { name: 'Alphabet Practice', theme: 'Letter formation', category: 'letters', difficulty: 'Starter' },
  'numbers-123': { name: 'Number Practice', theme: 'Number formation', category: 'letters', difficulty: 'Starter' },
  'big-heart-word': { name: 'LOVE Heart', theme: 'Word and heart', category: 'seasonal', difficulty: 'Starter' },
  'name-banner': { name: 'My Name Is', theme: 'Writing practice', category: 'letters', difficulty: 'Starter' },
  'latte-stone': { name: 'Latte Stone', theme: 'Guam landmark', category: 'island', difficulty: 'Starter' },
  'palm-island': { name: 'Coconut Tree', theme: 'Island curves', category: 'island', difficulty: 'Medium' },
  hibiscus: { name: 'Hibiscus', theme: 'Island flower', category: 'island', difficulty: 'Medium' },
  'proa-canoe': { name: 'Proa Canoe', theme: 'Guam sailing', category: 'island', difficulty: 'Medium' },
  'beach-hut': { name: 'Island Hut', theme: 'Island home', category: 'island', difficulty: 'Starter' },
  pumpkin: { name: 'Pumpkin', theme: 'Autumn curves', category: 'seasonal', difficulty: 'Starter' },
  snowflake: { name: 'Easy Snowflake', theme: 'Winter symmetry', category: 'seasonal', difficulty: 'Starter' },
  'heart-balloons': { name: 'Heart Balloons', theme: 'Celebration shapes', category: 'seasonal', difficulty: 'Starter' },
  'flying-kite': { name: 'Flying Kite', theme: 'Windy-day lines', category: 'seasonal', difficulty: 'Starter' },
  'birthday-cake': { name: 'Birthday Cake', theme: 'Celebration shapes', category: 'seasonal', difficulty: 'Starter' },
}

const addedDrawings: Drawing[] = [
  { id: 'line-paths', name: 'Line Paths', theme: 'Straight-line warmup', category: 'starters', difficulty: 'Starter', svg: revisedTemplateSvgs['line-paths'] },
  { id: 'waves-zigzags', name: 'Waves and Zigzags', theme: 'Pattern warmup', category: 'starters', difficulty: 'Starter', svg: revisedTemplateSvgs['waves-zigzags'] },
  { id: 'loops-spirals', name: 'Loops and Spirals', theme: 'Curve warmup', category: 'starters', difficulty: 'Starter', svg: revisedTemplateSvgs['loops-spirals'] },
  { id: 'easy-tree', name: 'Easy Tree', theme: 'Nature shapes', category: 'nature', difficulty: 'Starter', svg: revisedTemplateSvgs['easy-tree'] },
  { id: 'big-leaf', name: 'Big Leaf', theme: 'Veins and curves', category: 'nature', difficulty: 'Starter', svg: revisedTemplateSvgs['big-leaf'] },
  { id: 'rain-cloud', name: 'Rain Cloud', theme: 'Weather lines', category: 'nature', difficulty: 'Starter', svg: revisedTemplateSvgs['rain-cloud'] },
  { id: 'baby-dinosaur', name: 'Baby Dinosaur', theme: 'Animal curves', category: 'animals', difficulty: 'Medium', svg: revisedTemplateSvgs['baby-dinosaur'] },
  { id: 'ladybug', name: 'Ladybug', theme: 'Dots and symmetry', category: 'animals', difficulty: 'Starter', svg: revisedTemplateSvgs.ladybug },
